...
const fr = {
  ...
  "board.reset": "Reset",
  "board.returnFork": "Retour au fork",
  ...
  "settings.font.studio": "Outfit + Syne",
  ...
  "settings.appTheme.ink": "Encre",
  "settings.appTheme.marble": "Marbre",
  "settings.appTheme.arena": "Arène",
...
const en: Record<DictKey, string> = {
  ...
  "settings.appTheme.atelier": "Atelier",
  "settings.appTheme.ink": "Ink",
  "settings.appTheme.marble": "Marble",
  "settings.appTheme.arena": "Arena",
