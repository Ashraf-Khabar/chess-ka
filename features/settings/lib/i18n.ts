...
const en: Record<DictKey, string> = {
  ...
  "settings.appTheme.forest": "Forest",
  "settings.appTheme.midnight": "Midnight",
  "settings.appTheme.slate": "Slate",
  "settings.appTheme.ember": "Ember",
